const { randStr, formatVolume, formatCurrency }  =require(  '../util');


class Legend{
    constructor(containerId){
        this.containerId = containerId;
        this.barDetailsId = `details_${randStr(10)}`;
        this._setLegend();
    }
    ...
    _legendItemWrapper(_chartSeries, title, val){
        ...
        var actionId = `action_${this.containerId}_${randStr(10)}`;
        var valueId = `value_${this.containerId}_${randStr(10)}`;
