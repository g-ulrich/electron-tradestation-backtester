...
const {CHART_THEMES}  =require(  '../charts/options');
const { sortJsonArrayByKey, getRandomAlphaNum, maxJsonArrayVal, minJsonArrayVal, sessionHighlighter}  =require(  '../util');
const {Legend } =require(  './chartLegendClass');
const {Header}  =require(  './chartHeaderClass');
const {setMarketDataBarsAndStream, setMarketDataQuotesAndStream, prependMarketDataBars}  =require(  '../charts/customAPIBindings/getData');
// const { SessionHighlighting }  =require(  './plugins/session-highlighting/session-highlighting.js');
