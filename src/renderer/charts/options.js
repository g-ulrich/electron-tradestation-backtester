const { ColorType, LineStyle, CrosshairMode } = require('lightweight-charts');
...
const CHART_GRID = {
 ...
 const defaultSimpleChartOptions = (opts) => {
  return {
...
const defaultChartOptions = (opts) => {
...
module.exports = {grpChartOptions:grpChartOptions,
  defaultChartOptions:defaultChartOptions,
  defaultSimpleChartOptions:defaultSimpleChartOptions,
