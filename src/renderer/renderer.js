...
function addWindowButtons(){
    $('body').prepend(`
        <div class="position-fixed top-0 end-0 bg-dark w-100" style="z-index:999999; -webkit-app-region: drag;">
              <span class="text-secondary h6 p-0 px-1"><img height="18" style="margin-top:-3px;opacity:.3" class="rounded" src="../images/tradestation.png"/>radestation Backtester</span>
